...
От самой первой rd-131655 до новейшего снапшота. Релизы, снапшоты, бета, альфа — всё в одном каталоге, ставится в один клик. Список обновляется сам — новые версии появляются без перезапуска.
...
### Никакой регистрации
Создаёшь профиль на лету: вводишь никнейм — играешь. Можно держать несколько профилей и переключаться. Аккаунты Microsoft поддерживаются.
...
Minecraft — собственность Mojang/Microsoft. Trel не предоставляет игру и не обходит лицензию: клиент скачивается с официальных серверов Mojang. Запускать без купленного аккаунта можно только в одиночной игре и на серверах, где отключена проверка лицензии (`online-mode=false`). Для игры на официальных серверах нужен Microsoft-аккаунт, который Trel поддерживает.
